...
interface IClient {
    ...
    */
    get(key: ICacheKey, callback: ICallBack<null | ICachedObject>): CacheItem;
    /**
     ...
     */
    set(key: ICacheKey, value: CacheItem, ttl: number, callback: ICallBack<undefined>): void;
    /**
     * drop(key, callback) - remove an item from cache where:
     *  * key - a cache key object (see [ICacheKey]).
     *  * callback - a function with the signature function(err).
     */
    drop(key: ICacheKey, callback: ICallBack<undefined>): void;
...
interface IPolicy {
     ...
     */
    get(id: string, callback: IPolicyGetCallback): CacheItem;
    /**
     ...
     *  * callback - a function with the signature function(err).
     */
    set(id: string, value: CacheItem, ttl: number, callback: ICallBack<undefined>): void;
    /**
     * drop(id, callback) - remove the item from cache where:
     *  * id - the unique item identifier (within the policy segment).
     *  * callback - a function with the signature function(err).
     */
    drop(id: string, callback: ICallBack<undefined>): void;
    ...
    rules(options: IPolicyOptions): void;
